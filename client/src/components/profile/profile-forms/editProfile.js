...
const EditProfile = ({
  ...
  useEffect(() => {
    const callApi = async () => {
      try {
        ...
        setTimeout(() => {
          if (window.google) {
            let autoComplete = new window.google.maps.places
  ...
  useEffect(
    ...
    [isLoading, getCurrentUserProfile]
  );
      ...
      return (
        <tr key={_id} index={_id}>
          ...
          <td>
            ...
            {current ? "Present" : convertToLocalString(to)}
          </td>
          <td>
            <button
    ...
    <div className="section">
      ...
      <form onSubmit={e => onSubmit(e)}>
        ...
        <div className="form-group optional-btn-wrapper">
          ...
          >
            <i className="fas fa-plus" /> Education
          </button>
        </div>
        <div className="list-wrapper">
          {profile &&
        ...
        <div className="form-group optional-btn-wrapper">
          ...
          >
            <i className="fa fa-expand" aria-hidden="true" /> Social Link
          </button>
        </div>
        <Animated
          animationIn="fadeIn"
      ...
      <ExperienceForm
        submitHandler={addExperience_Education}
        setAlert={setAlert}
      />
      <EducationForm
        submitHandler={addExperience_Education}
